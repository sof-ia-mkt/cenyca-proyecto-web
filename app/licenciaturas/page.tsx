      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {licenciaturas.map(({ id, nombre, descripcion }) => (
              <Link
                key={id}
                href="/admisiones"
              ...
              >
                <span className="text-[#00D4FF] shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-300">
                  <IconoCarrera id={id} className="w-8 h-8" />
                </span>
                <div>
