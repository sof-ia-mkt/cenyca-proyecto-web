            ...
            >
              ...
              {doc.archivoUrl && (
                <a
                  ...
                  className="shrink-0 inline-flex items-center gap-2 bg-[#00D4FF] text-[#121B33] font-bold uppercase tracking-wide px-5 py-2.5 rounded-full text-xs hover:bg-white transition-colors"
                >
