          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
            <FadeLeft>
              <div className="bg-[#121B33] rounded-3xl p-10 h-full flex flex-col">
                ...
                <p className="font-montserrat text-white/70 leading-relaxed flex-1 text-justify">
            ...
            <FadeRight>
              <div className="bg-[#F5F7FF] border border-[#121B33]/10 rounded-3xl p-10 h-full flex flex-col">
                ...
                <p className="font-montserrat text-[#444] leading-relaxed flex-1 text-justify">
            ...
            {[
              ...
              <FadeUp key={item.año} delay={i * 0.1}>
                <div className="flex gap-6 items-start">
                  ...
                  <p className="font-montserrat text-white/70 leading-relaxed pt-0.5 text-justify">{item.texto}</p>
                </div>
              </FadeUp>
            ))}
          </div>
