    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          description:
            "Número al que se enviará el comprobante por WhatsApp. Si lo dejas vacío se usa el WhatsApp del contacto general. Formato con código de país, ejemplo: 526647719475.",
          type: "string",
        }),
      ],
    }),
