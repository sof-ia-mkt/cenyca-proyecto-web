  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="text-4xl sm:text-5xl font-black uppercase text-white mb-4 text-balance">{titulo}</h1>
        <p className="text-white/50 leading-relaxed mb-10 text-pretty">{descripcion}</p>
        <Link
          href="/"
